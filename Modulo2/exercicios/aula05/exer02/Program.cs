            ...
            do
            {
                ...
                if (ler.ToLower()=="s")
                {
                    ...
                    do
                    {
                        ...
                        {
                            Console.WriteLine("[3RR0R] Opção Inválidade!");
                        }
