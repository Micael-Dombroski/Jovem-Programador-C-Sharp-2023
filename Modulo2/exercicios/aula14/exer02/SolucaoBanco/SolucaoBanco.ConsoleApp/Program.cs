    ...
    class Program
    {
            ...
            do
            {
                ...
                switch (optMenuConta)
                {
                    ...
                    case 6:
                        ...
                        if (contaDAO.ConsultarPorAgenciaENumero(agencia, numero) is null)
                        {
                        ...
                        {
                            Conta conta = contaDAO.ConsultarPorAgenciaENumero(agencia, numero);
        ...
        static void MenuCliente()
        {
            ...
            do
            {
                ...
                Console.WriteLine("[3] Listar todas as cliente");
        ...
        static void AdicionarConta()
        {
            ...
            Resposta();
            int numero = int.Parse(ler);
            if (contaDAO.ConsultarPorAgenciaENumero(agencia,numero) != null)
            {
            ...
            Resposta();
            string cpf = ler;
            if (clienteDAO.ConsultarPorCPF(cpf) is null)
            {
                Console.WriteLine("Correntista Não Cadastrado!");
                Voltar();
                return;
            }
            Cliente correntista = clienteDAO.ConsultarPorCPF(cpf);
            Conta conta = null;
            switch (tipoConta)
            {
                case 1:
        ...
        static void EditarConta()
        {
            ...
            if (ler.ToLower() == "s")
            {
                ...
                } while (clienteDAO.ConsultarPorCPF(cpf) is null);
                contaEditada.Correntista = clienteDAO.ConsultarPorCPF(cpf);
            }
            contaEditada.Depositar(conta.Saldo);
            contaDAO.Editar(contaEditada);
        ...
        {
            if (contaDAO.ConsultarTodos() is null)
            {
            ...
            foreach (var item in contaDAO.ConsultarTodos())
            {
        ...
        static void ExcluirConta()
        {
            ...
            contaDAO.Excluir(agencia, numero);
        ...
        {
            if (contaDAO.ConsultarPorAgenciaENumero(conta.Agencia, conta.Numero) == null)
            {
                Console.WriteLine("[3RR0R] Essa Conta Não Pode Efetuar Saques pois Não Possui valor de Saldo Definido");
                Voltar();
                return;
            }
            conta.Sacar(valor);
        ...
        static void AdicionarCliente()
        {
            ...
            Resposta();
            string cpf = ler;
            if (clienteDAO.ConsultarPorCPF(cpf) != null)
            {
        ...
        {
            if (clienteDAO.ConsultarTodos() is null)
            {
