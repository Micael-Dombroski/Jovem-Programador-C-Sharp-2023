                ...
                switch (menuOpt)
                {
                    case 1:
                        ...
                        do
                        {
                            ...
                            {
                                Console.WriteLine("[3RR0R] Número de Conta Já Cadastrado!");
                                numeroJaCadastrado = true;
                            }
                            else
                            {
                                numeroJaCadastrado = false;
                            }
                        } while (numeroJaCadastrado == true);
                        ...
                        double saldo = double.Parse((double.Parse(Console.ReadLine())).ToString("F"));
                        switch (tipoConta)
                        {
                            case 1:
                                ContaPoupanca contaP = new ContaPoupanca(agencia, numero, correntista, saldo);
                                contas.Adicionar(contaP);
                                saldoTotal.SomarSaldo(contaP);
                                rendimentoTotal.AdicionarPoup(contaP);
                                break;
                            case 2:
                                ContaCorrente contaC = new ContaCorrente(agencia, numero, correntista, saldo);
                                contas.Adicionar(contaC);
                                saldoTotal.SomarSaldo(contaC);
                                break;
                            case 3:
                                ContaInvestimento contaI = new ContaInvestimento(agencia, numero, correntista, saldo);
                    ...
                    case 2:
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Deseja editar o Saldo da Conta? S/N");
                            ler = Console.ReadLine();
                            if (ler.ToLower() == "s")
                            {
                                Console.Write("Informe o Novo Saldo da Conta: ");
                    ...
                    case 3:
                        ...
                        foreach (var item in contas.Listar())
                        {
                            Console.Write(item.Agencia);
                            Console.Write("\t| ");
                            Console.Write(item.Numero);
                            Console.Write("\t| ");
                            Console.Write(item.Correntista);
                            Console.Write("\t| ");
                            Console.WriteLine($"R$ {item.Saldo.ToString("F")}");
                        }
                        Console.WriteLine("==========================");
                        break;
                    case 4:
                            ...
                            foreach (var item in contas.Listar())
                            {
                                if (item.Numero == nConta)
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        Console.WriteLine($"Correntista: {item.Correntista}");
                                        Console.WriteLine("========================");
                                        Console.WriteLine("=====Menu=====");
                                        ...
                                        switch (optConta)
                                        {
                                            case 1:
                                                ...
                                                item.Sacar(saque);
                                                if (rendimentoTotal.ExcluirInv(item.Numero)==true)
                                                {
                                                    rendimentoTotal.AdicionarInv((ContaInvestimento)item);
                                                }
                                                else if (rendimentoTotal.ExcluirPoup(item.Numero) == true)
                                                {
                                                    rendimentoTotal.AdicionarPoup((ContaPoupanca)item);
                                                }
                                                break;
                                            case 2:
                                                ...
                                                break;
                                            case 3:
                                                Console.WriteLine($"Seu Saldo Atual é: R$ {item.Saldo.ToString("F")}");
                                                break;
                                            default:
                                                Console.WriteLine("[3RR0R] Opção Inválida!");
                                                break;
                    ...
                    case 6:
                        Console.Clear();
                        Console.WriteLine($"Total de Todas as Contas: R$ {saldoTotal.Total.ToString("F")}");
                        break;
                    case 7:
                        Console.Clear();
                        Console.WriteLine($"Total do Rendimento Todas as Contas: R$ {rendimentoTotal.SomarRendimento().ToString("F")}");
                        break;
                    case 8:
                        Console.Clear();
