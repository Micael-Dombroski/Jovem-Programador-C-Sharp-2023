            ...
            do
            {
                do
                {
                    try 
                    {
                        ...
                        Console.WriteLine("7-Mostrar Testes");
                        ...
                        } else
                        {
                            ...
                            try
                            {
                                if (opt < 1 || opt > 7)
                                {
                                    throw new ArgumentOutOfRangeException("O valor informado precisar ser um número inteiro entre 1 e 7");
                                }
                ...
                switch (opt)
                {
                    ...
                    case 7:
                        ...
                        Console.WriteLine($"Testando Soma entre: {numero1} e {numero2} cujo o resultado deve ser {numero1 + numero2}");
                        Soma somar = new Soma(numero1,numero2);
                        Console.WriteLine("O Teste retorna " + (somar.Operacao() == resultado));
                        numero1 = 8.0;
                        numero2 = 3.0;
                        resultado = numero1 - numero2;
                        Console.WriteLine($"Testando Subtração entre: {numero1} e {numero2} cujo o resultado deve ser {numero1 - numero2}");
                        Subtracao subtrair = new Subtracao(numero1,numero2);
                        Console.WriteLine("O Teste retorna " + (subtrair.Operacao() == resultado));
                        numero1 = 5.0;
                        numero2 = 2.0;
                        resultado = numero1 / numero2;
                        Console.WriteLine($"Testando Divisão do número {numero1} por {numero2} cujo o resultado deve ser {numero1 / numero2}");
                        Divisao dividir = new  Divisao(numero1,numero2);
                        Console.WriteLine("O Teste retorna " +  (dividir.Operacao() == resultado));
                        numero1 = 7.0;
                        numero2 = 4.0;
                        resultado = numero1 * numero2;
                        Console.WriteLine($"Testando Multiplição do número {numero1} por {numero2} cujo o resultado deve ser {numero1 * numero2}");
                        Multiplicacao multiplicar = new Multiplicacao(numero1,numero2);
                        Console.WriteLine("O Teste retorna " + (multiplicar.Operacao() == resultado));
                        numero1 = 4.0;
                        numero2 = 3.0;
                        resultado = Math.Pow(numero1,numero2);
                        Console.WriteLine($"Testando Potência de base {numero1} elevado por {numero2} cujo o resultado deve ser {Math.Pow(numero1,numero2)}");
                        PotenciaBaseQualquer potenciacao = new PotenciaBaseQualquer(numero1,numero2);
                        Console.WriteLine("O Teste retorna " + (potenciacao.Operacao() == resultado));
                    break;
                    default:
