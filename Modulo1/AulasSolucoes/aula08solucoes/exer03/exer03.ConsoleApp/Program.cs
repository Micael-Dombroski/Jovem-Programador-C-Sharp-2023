            ...
            try
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    else
                    {
                        if (i < 9)
                        {
                            num1 += (ValorNumero(cpf[i])) * multiplicador; // gerando um cpf válido cpf 12345678909
                            //(1*10)+(2*9)+(3*8)+(4*7)+(5*6)+(6*5)+(7*4)+(8*3)+(9*2)=28+52+60+52+18=80+60+70=210%11=1
                            //(1*11)+(2*10)+(3*9)+(4*8)+(5*7)+(6*6)+(7*5)+(8*4)+(9*3)+(0*2)=11+20+27+32+35+36+35+32+27+0=31+59+71+67+27=90+71+94=255%11=2
                        }
