            ...
            do
            {
                try 
                {
                    ...
                    } else
                    {
                        ...
                        if (opt < 1 || opt > 6)
                        {
                            throw new ArgumentException("O valor informado não é válido para essa campo");
                        }
                    }   
                ...
                case 3:
                    ...
                    do
                    {
                        ...
                        try
                        {
                            ...
                            {
                                Num2 = false;
                                throw new ArgumentException("Não se pode dividir um número por zero ou um número negativo");
                            }
                ...
                case 6:
                    ...
                    do
                    {
                        ...
                        try
                        {
                            ...
                            n2 = Convert.ToDouble(ler);
                            Calculadora potencia = new Potencia(n1,n2);
