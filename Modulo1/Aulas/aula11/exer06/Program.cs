...
namespace exer06
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int [] datanow = new int [3];
            datanow[0] = Convert.ToInt32(data.Day);
            datanow[1] = Convert.ToInt32(data.Month);
            datanow[2] = Convert.ToInt32(data.Year);
                ...
                switch (resposta)
                {
                    case 1:
                        if (c < 1)
                        {
                            ...
                            Console.Write("Informe a dia de nascimento do novo correntista: ");
                            var dia = Console.ReadLine();
                            datas [c,0] = Convert.ToInt32(dia);
                            Console.WriteLine();
                            Console.Write("Informe a mês de nascimento do novo correntista: ");
                            var mes = Console.ReadLine();
                            datas [c,1] = Convert.ToInt32(mes);
                            Console.WriteLine();
                            Console.Write("Informe a ano de nascimento do novo correntista: ");
                            var ano = Console.ReadLine();
                            datas [c,2] = Convert.ToInt32(ano);
                            Console.WriteLine();
                            while (dmaior < 1)
                            {
                                if ((datanow[2]-datas[c,2]) == 18)
                                {
                                    if (datanow[1]==datas[c,1])
                                    {
                                        if (datanow[0]<=datas[c,0])
                                        {
                                            dmaior = 1;
                                        } else
                                        {
                                            Console.WriteLine("Não podemos cadastras um correntista menor de idade...");
                                            Console.Write("Informe a dia de nascimento do novo correntista: ");
                                    ...
                                    } else if (datanow[1]<datas[c,1])
                                    {
                                        dmaior=1;
                                    } else
                                    {
                                        Console.WriteLine("Não podemos cadastrar um correntista menor de idade...");
                                        Console.Write("Informe a dia de nascimento do novo correntista: ");
                                        dia = Console.ReadLine();
                                        datas [c,0] = Convert.ToInt32(dia);
                                        Console.WriteLine();
                                ...
                                } else if ((datanow[2]-datas[c,2]) > 18)
                                {
                                    dmaior=1;
                                } else
                                {
                        ...
                        for (int i = 0; i < c; i++)
                        {
                            if (ler == correntista[i,0])
                            {
                                ...
                                if (ler.ToLower()=="sim")
                                {
                                    ...
                                    var dia = Console.ReadLine();
                                    datas [i,0] = Convert.ToInt32(dia);
                                    Console.WriteLine();
                                    Console.Write("Informe a mês de nascimento do correntista: ");
                                    var mes = Console.ReadLine();
                                    datas [i,1] = Convert.ToInt32(mes);
                                    Console.WriteLine();
                                    Console.Write("Informe a ano de nascimento do correntista: ");
                                    var ano = Console.ReadLine();
                                    datas [i,2] = Convert.ToInt32(ano);
                                    Console.WriteLine();
                                    while (dmaior < 1)
                                    {
                                        if ((datanow[2]-datas[i,2]) == 18)
                                        {
                                            if (datanow[1]==datas[i,1])
                                            {
                                                if (datanow[0]<=datas[i,0])
                                                {
                                                    dmaior = 1;
                                                } else
                                                {
                                        ...
                                        } else if ((datanow[2]-datas[i,2]) > 18)
                                        {
                                            dmaior=1;
                                        } else
                                        {
                    ...
                    case 3:
                        ...
                        for (int i = 0; i < c; i++)
                        {
                            if (ler == correntista[i,0])
                            {
                                ...
                                Console.WriteLine($"Idade: {(data.Year-datas[i,2])} anos");
                        ...
                        for (int i = 0; i < c; i++)
                        {
                            if (ler == correntista[i,0])
                            {
                                ...
                                if (ler1 == "sim")
                                {
                                    ...
                                    reduzarraydata (c, ref correntista, ler, ref datas);
                                    c--;
        ...
        static void aumentararraydata (int cont, ref int [,] array)
        {
            int [,] temp = new int [cont+1,3];
                for (int i = 0; i < cont ; i++)
                {
                    temp [i,0] = array [i,0];
                    temp [i,1] = array [i,1];
        ...
        static void reduzarraydata (int cont, ref string [,] array,string leitura, ref int[,] data)
        {
            int [,] temp = new int [cont,3];
            int v=0;
            for (int n = 0; n < cont; n++)
            {
                if (array[n,0] == leitura)
